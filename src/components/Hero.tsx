...
export default function Hero() {
  ...
  return (
    <section className="relative pt-32 pb-20 md:pt-40 md:pb-28 overflow-hidden bg-radial-glow">
      ...
      <div className="absolute top-1/3 right-10 w-[350px] h-[350px] bg-amber-400/10 rounded-full blur-[100px] pointer-events-none" />
        ...
        <div className="flex flex-col items-center justify-center max-w-4xl mx-auto">
          <ScrollStagger staggerChildren={0.1} className="w-full flex flex-col gap-6 text-center items-center justify-center">
            ...
            <ScrollStaggerItem direction="down" distance={15}>
              <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-blue-50 border border-blue-200 text-[#00658D] text-xs font-semibold self-center shadow-sm">
            ...
            <ScrollStaggerItem direction="fade" distance={15}>
              <div className="flex flex-col sm:flex-row items-center gap-4 pt-2 justify-center">
                <a
                  ...
                  className="w-full sm:w-auto px-8 py-4 rounded-full bg-gradient-to-r from-[#00658D] via-[#0284C7] to-[#F59E0B] text-white font-bold text-base hover:shadow-xl hover:shadow-amber-500/25 transition-all transform hover:-translate-y-1 flex items-center justify-center gap-3 group"
                >
                ...
                <a
                  href="#portofolio"
                  className="w-full sm:w-auto px-7 py-4 rounded-full bg-slate-100 hover:bg-slate-200 border border-slate-200 text-slate-700 font-semibold text-base transition-all flex items-center justify-center gap-2 hover:border-sky-400"
                >
