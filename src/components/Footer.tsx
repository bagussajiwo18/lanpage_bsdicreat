    ...
    <footer className="bg-slate-900 border-t border-slate-800 pt-16 pb-12 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 pb-12 border-b border-slate-700">
          ...
          <div className="md:col-span-5 flex flex-col gap-4">
            ...
            <div className="flex items-center gap-3 pt-2">
              <a
                ...
                className="w-10 h-10 rounded-xl bg-white/5 border border-slate-700 hover:border-cyan-400 text-slate-400 hover:text-cyan-400 flex items-center justify-center transition-all"
              >
          ...
          {/* Col 3: CTA Box */}
          <div className="md:col-span-4 p-6 rounded-2xl bg-white/5 border border-slate-700 flex flex-col justify-between">
            <div>
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="w-full py-3 rounded-xl bg-gradient-to-r from-[#00658D] to-[#35A7E0] text-white text-xs font-bold shadow-md shadow-cyan-500/20 hover:shadow-cyan-500/30 transition-all flex items-center justify-center gap-2"
            >
              <WhatsAppIcon className="w-4 h-4" />
