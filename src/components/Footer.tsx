...
export default function Footer() {
  ...
  return (
    <footer className="bg-slate-900 border-t border-slate-800 pt-16 pb-12 relative overflow-hidden">
      ...
      <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-[600px] h-[200px] bg-sky-500/5 blur-[140px] pointer-events-none" />
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-12 pb-12 border-b border-slate-700">
            ...
            <div className="md:col-span-5 flex flex-col gap-4">
              <a href="#" className="flex items-center gap-3 group">
                ...
                <span className="font-extrabold text-2xl tracking-tight text-white group-hover:text-[#F59E0B] transition-colors">
                  BS DICREAT
                </span>
              </a>
              ...
              <div className="flex items-center gap-3 pt-2">
                <a
                  ...
                  className="w-10 h-10 rounded-xl bg-white/5 border border-slate-700 hover:border-amber-400 text-slate-400 hover:text-amber-400 flex items-center justify-center transition-all hover:scale-110"
                >
            ...
            <div className="md:col-span-3">
              ...
              <ul className="space-y-2.5 text-sm text-slate-400">
                <li><a href="#layanan" className="hover:text-amber-400 transition-colors">Layanan Desain</a></li>
                <li><a href="#portofolio" className="hover:text-amber-400 transition-colors">Portofolio Klien</a></li>
                <li><a href="#alur-kerja" className="hover:text-amber-400 transition-colors">Alur Kerja</a></li>
                <li><a href="#ulasan" className="hover:text-amber-400 transition-colors">Ulasan &amp; Testimoni</a></li>
                <li><a href="#faq" className="hover:text-amber-400 transition-colors">FAQ</a></li>
              </ul>
            </div>

            {/* Col 3: CTA Box */}
            <div className="md:col-span-4 p-6 rounded-2xl bg-white/5 border border-slate-700 flex flex-col justify-between hover:border-amber-400/50 transition-colors duration-300">
              <div>
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-full py-3 rounded-xl bg-gradient-to-r from-[#00658D] via-[#0284C7] to-[#F59E0B] text-white text-xs font-bold shadow-md shadow-amber-500/20 hover:shadow-amber-500/30 transition-all flex items-center justify-center gap-2 hover:scale-[1.02]"
              >
                <WhatsAppIcon className="w-4 h-4" />
